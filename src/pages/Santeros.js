...
const Santeros = () => {
  return(
    <div className="col_content">
        ...
        After some gigs, the drumer/sound designer <a className="text_link" href={rolando} target="_blank" rel="noreferrer">Rolando Camilo</a> suggested that they should have another project, which would focus only on his original compositions. A "Brazilian Radiohead" or "Latin Pink Floyd" sort of thing.
